if(!sessionStorage.getItem("car_id")){window.location = 'home.html';}
...
let url = `http://localhost/laravelapp/public/api/view/maintenance/${sessionStorage.getItem("car_id")}`;
doRequest(url, 'GET', '');
...
//definição do modelo do carro no H1

document.getElementById("h1-car").innerHTML = 
`
    ESTAS SÃO AS MANUTENÇÕES PREVISTAS PARA O SEU VEÍCULO: ${sessionStorage.getItem("car_model")}
`;